...
A Vai can illuminate their surroundings, while an Aalharis can create what is practically a miniature sun, with sufficient[^2] mana. However, the gap between Alhvarikos and Aalharis is incomparable, as divine runes can be declared to be infinitely more powerful, whilst as simple[^3] as a First Circle rune.
